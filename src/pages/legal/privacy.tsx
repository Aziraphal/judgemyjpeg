            ...
            <div className="glass-card p-8 space-y-8">
              ...
              <section>
                ...
                <div className="text-text-gray space-y-3">
                  ...
                  <p><strong>Email :</strong> contact.judgemyjpeg@gmail.com</p>
                  <p><strong>Contact :</strong> contact.judgemyjpeg@gmail.com</p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="text-text-gray space-y-4">
                  ...
                  <div className="bg-neon-cyan/10 p-4 rounded-lg border border-neon-cyan/30 mt-6">
                    ...
                    <p className="text-sm">
                      <strong>Email :</strong> contact.judgemyjpeg@gmail.com<br/>
                ...
                <div className="text-text-gray space-y-3">
                  <div className="bg-yellow-500/10 p-4 rounded-lg border border-yellow-500/30">
                    ...
                    <ul className="text-sm space-y-1">
                      ...
                      <li>• Contact parents : contact.judgemyjpeg@gmail.com</li>
                    </ul>
                  </div>
                </div>
              </section>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <ul className="space-y-2 text-sm">
                        <li><strong>Questions générales :</strong><br/>contact.judgemyjpeg@gmail.com</li>
                        <li><strong>Exercice des droits :</strong><br/>contact.judgemyjpeg@gmail.com</li>
                        <li><strong>Signalement incident :</strong><br/>contact.judgemyjpeg@gmail.com</li>
