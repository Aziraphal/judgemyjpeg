                ...
                <div className="text-text-gray space-y-3">
                  ...
                  <div className="bg-cosmic-glass p-4 rounded-lg">
                    <ul className="space-y-2 text-sm">
                      <li><strong>Email général :</strong> privacy@judgemyjpeg.com</li>
                      <li><strong>Questions cookies :</strong> cookies@judgemyjpeg.com</li>
                      <li><strong>DPO :</strong> dpo@judgemyjpeg.com</li>
                      <li><strong>Support technique :</strong> support@judgemyjpeg.com</li>
                    </ul>
                  </div>
                </div>
              </section>
